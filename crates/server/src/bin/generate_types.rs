...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::implication_autopilot::AutopilotWorkflowState::decl(),
        ...
        server::routes::implication_autopilot::BatchAdvanceCard::decl(),
        server::routes::implication_autopilot::BatchAdvancePlan::decl(),
        server::routes::implication_autopilot::BatchAdvancePlanRequest::decl(),
        server::routes::implication_autopilot::BatchAdvanceRelationship::decl(),
        server::routes::implication_autopilot::BatchAdvancePlanCandidate::decl(),
